...
window.SV = (function () {
  ...
  var services = [
    ...
    },
    {
      ...
      icon: "uniform",
      image: "assets/img/products/uniform-thadi-tigers-studio.jpg",
      points: [
    ...
    },
    {
      ...
      icon: "cap",
      image: "assets/img/products/caps-custom-color-lineup.jpg",
      points: [
    ...
    },
    {
      ...
      icon: "bag",
      image: "assets/img/products/jute-wedding-pair-studio.jpg",
      points: [
  ...
  var work = [
    ...
    },
    {
      ...
      category: "uniforms",
      image: "assets/img/products/uniform-jersey-sekhar-143.jpg",
      provenance: "real",
    ...
    },
    {
      ...
      category: "uniforms",
      image: "assets/img/products/uniform-orange-cheyutha-studio.jpg",
      provenance: "real",
    ...
    },
    {
      ...
      category: "caps",
      image: "assets/img/products/cap-wide-brim-studio.jpg",
      provenance: "real",
    ...
    },
    {
      ...
      category: "caps",
      image: "assets/img/products/caps-bulk-white-studio-grid.jpg",
      provenance: "mock",
    ...
    },
    {
      ...
      category: "caps",
      image: "assets/img/products/caps-custom-embroidered-stack.jpg",
      provenance: "mock",
    ...
    },
    {
      ...
      category: "caps",
      image: "assets/img/products/caps-custom-services-flatlay.jpg",
      provenance: "mock",
    ...
    },
    {
      ...
      category: "caps",
      image: "assets/img/products/caps-bulk-white-order-ready-branded-v2.jpg",
      provenance: "mock",
    ...
    },
    {
      ...
      category: "jute-bags",
      image: "assets/img/products/jute-pink-custom-studio.jpg",
      provenance: "real",
    ...
    },
    {
      ...
      category: "jute-bags",
      image: "assets/img/products/jute-finished-bulk-dispatch.jpg",
      provenance: "mock",
    ...
    },
    {
      ...
      category: "tshirts",
      image: "assets/img/products/couple-tshirts-together-forever.jpg",
      provenance: "real",
    ...
    },
    {
      ...
      category: "tshirts",
      image: "assets/img/products/couple-tshirts-stole-heart-last-name.jpg",
      provenance: "real",
    ...
    },
    {
      ...
      category: "tshirts",
      image: "assets/img/products/couple-tshirts-heartbeat-him-her.jpg",
      provenance: "real",
    ...
    },
    {
      ...
      category: "tshirts",
      image: "assets/img/products/couple-tshirts-trapped-trap.jpg",
      provenance: "real",
    ...
    },
    {
      ...
      category: "tshirts",
      image: "assets/img/products/textile-print-detail.jpg",
      provenance: "real",
    ...
    },
    {
      ...
      category: "caps",
      image: "assets/img/products/caps-gcl-bulk-order.jpg",
      provenance: "real",
